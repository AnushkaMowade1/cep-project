      ...
      <div className="container mx-auto px-6 py-12">
        <div className="text-center space-y-8">
          <div className="space-y-4">
            <h1 className="text-4xl md:text-6xl font-serif font-bold text-balance"><span className="text-orange-600 font-bold italic" style={{fontFamily: "'AMS Aasmi', 'Noto Sans Devanagari', sans-serif", fontSize: '1.1em', textShadow: '2px 2px 4px rgba(0,0,0,0.1)', transform: 'skew(-5deg)', display: 'inline-block', fontWeight: 'bold'}}>कला</span> Bazaar</h1>
