      ...
      <header className="border-b bg-card">
        <div className="container mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-2xl font-serif font-bold">Welcome to <span className="text-orange-600 italic" style={{fontFamily: "'AMS Aasmi', 'Noto Sans Devanagari', sans-serif", fontSize: '1.1em', textShadow: '1px 1px 2px rgba(0,0,0,0.1)', transform: 'skew(-3deg)', display: 'inline-block', fontWeight: 'bold'}}>कला</span> Bazaar</h1>
      ...
      <div className="container mx-auto px-6 py-8">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Your recent purchases from <span className="text-orange-600 font-medium italic" style={{fontFamily: "'AMS Aasmi', 'Noto Sans Devanagari', sans-serif", fontSize: '1.05em', textShadow: '1px 1px 2px rgba(0,0,0,0.1)', transform: 'skew(-2deg)', display: 'inline-block', fontWeight: 'bold'}}>कला</span> Bazaar</CardDescription>
          </CardHeader>
          <CardContent>
            {orders.length === 0 ? (
